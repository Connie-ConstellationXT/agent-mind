...
### [00 - Foreword: On Expressibility and the Shape of Experience](00_00_foreword.md)
Before talking about symbolic systems, we must recognize that not all experience can be symbolized. Distinguishes between what can be felt (Q), what can be predicted (Q'), and what can be discussed (Q°).

### [01 - Of Truth and Hallucinations](00_01_of_truth_and_hallucinations.md)
...
### [02 - Truth Gradient and Metabolic Chirality](00_02_truth_gradient_and_metabolic_chirality.md)
...
### [03 - Cognition as Orbital Mechanics](00_03_cognition_as_orbital_mechanics.md)
...
### [04 - Delta-H and Model Divergence](00_04_delta_h_and_model_divergence.md)
...
### [05 - Inward Self-Projection: The Planning Manifold](00_05_inward_planning_manifold.md)
...
### [06 - P vs NP: The Computational Horizon of Reconvergence](00_06_p_vs_np_and_fault_tolerance.md)
...
### [07 - Inter-Agent Collaboration](00_07_inter_agent_collaboration.md)
Explains how multiple agents can share planning manifolds and reconcile divergent trajectories.
...
- Why **SIMD N⁺ convergence detection** (Chapter 7) is architecturally necessary
- Why the **Global World Model** (Chapter 5) must be persistent and unified
